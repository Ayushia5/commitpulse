...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around border-t border-gray-200 dark:border-white/10 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md px-2 py-2">
        <Link
          href="/generator"
          className={
            pathname === '/generator'
              ? 'flex flex-col items-center gap-1 px-3 py-1 rounded-xl text-xs font-medium text-gray-900 dark:text-white'
              : 'flex flex-col items-center gap-1 px-3 py-1 rounded-xl text-xs font-medium text-gray-500 dark:text-gray-400'
          }
        >
          <Zap size={20} />
          <span>Generator</span>
